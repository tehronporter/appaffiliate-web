...
export function LoginForm({ redirectTo }: LoginFormProps) {
  ...
  return (
    <div className="rounded-[24px] border border-[color:color-mix(in_srgb,var(--color-primary)_12%,var(--color-border))] bg-[linear-gradient(180deg,rgba(255,255,255,0.96)_0%,rgba(249,251,255,0.98)_100%)] p-6 shadow-[0_18px_44px_rgba(17,24,39,0.07)] sm:p-8">
        ...
        <label className="block space-y-2">
          ...
          <span className="relative block">
            ...
            <input
              ...
              className="aa-field h-12 rounded-[14px] border-[color:color-mix(in_srgb,var(--color-primary)_8%,var(--color-border))] bg-white pl-11 shadow-[inset_0_1px_0_rgba(255,255,255,0.7)]"
      ...
      <div className="mt-6 rounded-[18px] border border-[color:color-mix(in_srgb,var(--color-primary)_8%,var(--color-border))] bg-white/72 px-4 py-4">
